...
def serializedATN():
    return [
        ...
        11,5,1,0,0,11,25,3,2,1,6,12,13,10,5,0,0,13,14,5,2,0,0,14,25,3,2,
        ...
        1,3,24,9,1,0,0,0,24,12,1,0,0,0,24,15,1,0,0,0,24,18,1,0,0,0,24,21,
...
class exprsParser ( Parser ):
    ...
    class MultiplicacioContext(ExprContext):
        ...
        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterMultiplicacio" ):
                listener.enterMultiplicacio(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitMultiplicacio" ):
                listener.exitMultiplicacio(self)
    ...
    class DivisioContext(ExprContext):
        ...
        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterDivisio" ):
                listener.enterDivisio(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitDivisio" ):
                listener.exitDivisio(self)
